/*** Autogenerated by WIDL 11.14 from /home/books/Projects/power8/vkd3d-proton/include/vkd3d_d3dcommon.idl - Do not edit ***/
...
typedef void (__stdcall *PFN_DESTRUCTION_CALLBACK)(void *a);
/*****************************************************************************
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define ID3DDestructionNotifier_QueryInterface(This,riid,object) (This)->lpVtbl->QueryInterface(This,riid,object)
...
/*** ID3DDestructionNotifier methods ***/
#define ID3DDestructionNotifier_RegisterDestructionCallback(This,callback,data,callback_id) (This)->lpVtbl->RegisterDestructionCallback(This,callback,data,callback_id)
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3DDestructionNotifier_QueryInterface(ID3DDestructionNotifier* This,REFIID riid,void **object) {
    return This->lpVtbl->QueryInterface(This,riid,object);
}
...
/*** ID3DDestructionNotifier methods ***/
static inline HRESULT ID3DDestructionNotifier_RegisterDestructionCallback(ID3DDestructionNotifier* This,PFN_DESTRUCTION_CALLBACK callback,void *data,UINT *callback_id) {
    return This->lpVtbl->RegisterDestructionCallback(This,callback,data,callback_id);
}
